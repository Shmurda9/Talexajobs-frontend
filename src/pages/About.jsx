...
function PostJob() {
  ...
  // Smart Salary Formatter (adds commas)
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Strip commas before sending to backend
  ...
  // Original precise styling perfectly preserved
            ...
            <form onSubmit={handleSubmit} className="space-y-10">
              ...
              <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
                  ...
                  >
                    ...
                    {/* Original small toggle dimensions */}
              ...
              <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  {/* Seamless Currency Dropdown & Salary Input */}
                  <div>
                    <label className={labelClass}>Yearly Salary</label>
                    <div className="flex relative shadow-sm rounded-xl">
                      <div className="relative flex items-center border border-slate-200 border-r-0 rounded-l-xl bg-slate-50 focus-within:ring-2 focus-within:ring-blue-500/50 focus-within:bg-white transition-all">
                        <select 
                          value={currency} 
                          onChange={(e) => setCurrency(e.target.value)}
                          className="appearance-none bg-transparent pl-4 pr-8 py-3.5 font-bold text-slate-700 focus:outline-none cursor-pointer z-10"
                        >
                          <option value="$">$</option>
                          <option value="€">€</option>
                          <option value="£">£</option>
                ...
                <div className="mt-6">
                  ...
                  <div className="relative mt-2">
                    ...
                    {/* Kept URL placeholder as requested */}
